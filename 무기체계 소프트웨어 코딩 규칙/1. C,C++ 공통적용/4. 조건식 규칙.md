...
<font color="#00b050">가) float 자료형에서 동등성 비교연산을 수행하지 말아야 한다.</font>

<font color="#00b050">나) 조건문의 결과가 항상 True 혹은 False라면 이는 조건문으로 작성해서는 안된다.</font>

<font color="#00b050">다) switch의 case의 조건을 만족할 수 없는 Label을 사용하지 않는다.</font>

<font color="#00b050">라) Switch 구문에서 Expression을 논리적 연산으로 사용하지 말아야 한다.</font>

<font color="#00b050">마) 수행되지 않는 소스코드를 작성하지 말아야 한다.</font>(CSA,Tidy)
