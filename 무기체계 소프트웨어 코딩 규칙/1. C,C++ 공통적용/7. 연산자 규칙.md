...
<font color="#00b050">가) 하나의 Sequence Point 내에서 하나의 Object Value를 두 번 이상 변경하지 않아야 한다.</font>

<font color="#00b050">나) 나누는 값이 변수일 경우 0인지를 반드시 확인하여야 한다.</font>(Tidy, CSA): 포인터 엘리어싱 추가고려

<font color="#00b050">다) 하나의 Sequence Point내에서 Object의 값을 변경하고 Access 하지 않아야 한다.</font>

<font color="#00b050">라) 음수 값 또는 데이터 사이즈를 초과하는 값을 사용하여 Shift operator를 하지 않는다.</font>(Tidy(상수만), CSA)

<font color="#00b050">마) Underlying type이 Unsigned인 데이터에 '-'를 사용하여 결과를 assign하지 말아야 한다.</font>

<font color="#00b050">바) ’sizeof’의 인자로 side effect를 포함하는 식을 사용하면 안된다.</font>

<font color="#00b050">사) Boolean 표현 값에는 논리 연산자(&&, ||, !)만을 사용하여야 한다.</font>

<font color="#00b050">아) condition에 assignment operator를 사용하지 말아야 한다.</font>
<font color="#00b050">- 조건문에 대입연산자 사용 x</font>

<font color="#00b050">자) Signed Value에서 Bitwise연산자(<<, ~, |, ^ 등)로 인한 Negative Value를 유의해야 한다.</font>
<font color="#00b050">- 부호 비트의 손상을 방지해야한다.</font> (Tidy, CSA)
