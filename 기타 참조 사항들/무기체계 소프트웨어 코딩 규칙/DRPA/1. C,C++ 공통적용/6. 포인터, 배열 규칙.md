...
<font color="#00b050">가) 포인터는 참조전에 NULL 여부를 반드시 확인하여야 한다.</font>
...
<font color="#00b050">라) 선언된 배열의 크기를 초과하는 인덱스 값을 사용하지 말아야 한다.</font>(Tidy, CSA)

<font color="#00b050">마) Null Pointer를 산술연산 하지 않는다.</font>(추후 CSA 확장)
