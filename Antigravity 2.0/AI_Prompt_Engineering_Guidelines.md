...
- [Source] Anthropic 공식 문서 (2024-2025, 지속 업데이트)
...
- 현재 GRC 적용 상태:
  → 챗뷰 서식 규칙에 <example> 태그로 대사/독백 예시 1개 포함 ✅
  → 에이전트 프롬프트에는 Few-shot 예시 없음 ⚠️ (개선 여지)
...
### 실전 규칙 (GRC 적용)
- 상태창 갱신: ThinkingLevel.minimal ✅ (단순 JSON 변환)
- 중기 서사 요약: ThinkingLevel.high ✅ (복잡한 서사 융합)
- 장기 기억 병합: ThinkingLevel.medium ✅ (중간 복잡도의 압축)
...
### 원칙
CJK 언어(한/중/일)는 토큰화 차이로 인해 같은 의미의 텍스트에 
...
- 태그와 구분자: XML 태그는 영어로 유지 (<rules>, <output_format> 등) ✅
- 토큰 효율: 프롬프트 내 불필요한 반복 서술 최소화
- 출력 언어 명시: 명시적으로 "반드시 한국어로 작성하십시오" 포함 ✅

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

## 12. Self-Correction 패턴 (향후 적용 고려)
